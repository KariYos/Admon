...
namespace DLL_Ventas
{
    public partial class _4205_Factura : Form
    {
        ...
        public _4205_Factura(DataGridView dgv)
        {
            InitializeComponent();
            nv.nombreForm(this);
            nv.dgv_datos(dgv);
        ...
        private void Btn_agregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Dgb_factura.Rows.Add(Txt_codigo.Text, Cbo_descripcion.Text, Txt_cantidad.Text, Txt_precioU.Text, doIva, doSub, Txt_descuento.Text, doDesc, doTotal);
                ...
                priCalcularTotales(5, 4, 7, 8, Dgb_factura);
            }
            catch (Exception ex)
            {
        ...
        private void Dgb_factura_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                iFila = 0;
                iFila = Convert.ToInt32(Dgb_factura.CurrentCell.RowIndex.ToString());
            }
            catch (Exception ex)
            {
        ...
        private void Btn_eliminar_Click(object sender, EventArgs e)
        {
            try
            {
                Dgb_factura.Rows.RemoveAt(iFila);                //Eliminar la fila seleccionada.
        ...
        {
            Help.ShowHelp(this, "C:/ayuda/ModuloAdmon.chm", "factura.html");     //Ayuda al presionar f1
        }
    }
}
